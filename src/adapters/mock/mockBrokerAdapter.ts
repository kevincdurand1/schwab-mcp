...
import  {
  ...
  type GetInstrumentByCusipParams,
  type GetNewsParams,
  type GetEarningsCalendarParams,
  type GetDividendHistoryParams,
...
class MockAccountsAPI implements AccountsAPI {
...
class MockQuotesAPI implements QuotesAPI {
...
class MockOrdersAPI implements OrdersAPI {
  async getOrders(params: GetOrdersParams): Promise<Order[]> {
    ...
    return mockOrders.filter(order => 
      !params.accountNumber || order.accountNumber === params.accountNumber
    );
  }
  ...
  async replaceOrder(params: any): Promise<any> {
  ...
  async cancelOrder(orderId: string, accountNumber: string): Promise<any> {
...
class MockTransactionsAPI implements TransactionsAPI {
  async getTransactions(params: GetTransactionsParams): Promise<Transaction[]> {
    ...
    return mockTransactions.filter(txn => 
      !params.accountNumber || txn.accountNumber === params.accountNumber
    );
  }
  ...
  async getTransaction(transactionId: string, accountNumber: string): Promise<Transaction> {
    ...
    const transaction = mockTransactions.find(t => 
      t.transactionId === transactionId && t.accountNumber === accountNumber
    );
...
class MockMarketDataAPI implements MarketDataAPI {
  private quotesAPI: MockQuotesAPI;
  ...
  async getInstrumentByCusip(params: GetInstrumentByCusipParams): Promise<any> {
  ...
  async getEarningsCalendar(params: GetEarningsCalendarParams): Promise<EarningsEvent[]> {
  ...
  async getDividendHistory(params: GetDividendHistoryParams): Promise<DividendEvent[]> {
  ...
  async getCompanyProfile(params: GetCompanyProfileParams): Promise<CompanyProfile> {
...
class MockPortfolioAPI implements PortfolioAPI {
  ...
  async getPortfolioSummary(params: GetPortfolioSummaryParams): Promise<Portfolio> {
  ...
  async getPerformance(params: GetPerformanceParams): Promise<Performance> {
...
class MockWatchlistAPI implements WatchlistAPI {
  async getWatchlists(params: GetWatchlistsParams): Promise<Watchlist[]> {
  ...
  async createWatchlist(params: CreateWatchlistParams): Promise<Watchlist> {
  ...
  async addToWatchlist(params: AddToWatchlistParams): Promise<any> {
  ...
  async removeFromWatchlist(params: RemoveFromWatchlistParams): Promise<any> {
...
class MockActivityAPI implements ActivityAPI {
  async getAccountActivity(params: GetAccountActivityParams): Promise<AccountActivity[]> {
...
export class MockBrokerAdapter implements BrokerClient {
  public readonly brokerName = 'mock';
  ...
  static async create(accessToken: string): Promise<MockBrokerAdapter> {
